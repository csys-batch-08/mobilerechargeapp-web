...
<body>
	...
	<div class="header">
		<a href="operator.jsp">Home</a> <a href="wallet.jsp">wallet</a> <a
			href="ViewHistoryController">RechargeHistory</a> <a
			href="aboutus.jsp">AboutUs</a> <a href="ContactUs.jsp">ContactUs</a>
		<a href="index.jsp">Logout</a>
	</div>
	<div align="center">
		<div class="singleCard">
			<a href="planJioUser"><strong>Jio</strong></a> <img
				src="assets/images/jiologo.jpg"
				alt="Some textual description of jio.jpg">
		</div>
		<div class="singleCard">
			<a href="planAirtelUser"><strong>Airtel</strong></a> <img
				src="assets/images/airtel logo.png"
				alt="Some textual description of airtel.png">
		</div>
		<div class="singleCard">
			<a href="planVodafoneUser"><strong>vodafone</strong></a> <img
				src="assets/images/VI-Logo-PNG.jpg"
				alt="Some textual description of vodafone.jpg">
		</div>
		<div class="singleCard">
			<a href="planBsnlUser"><strong>Bsnl</strong></a> <img
				src="assets/images/BSNL logo.png"
				alt="Some textual description of bsnl.jpg">
		</div>
	</div>
