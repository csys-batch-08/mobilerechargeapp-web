...
<body style="text-align: center;">
	...
	<h1>
		<strong>VODAFONE NETWORK</strong>
	</h1>
		...
		<tr>
			...
			<c:forEach items="${requestScope.vodafonelist}" var="vodafoneUser">
				<tr>
					...
					<td><a
						href="vodafoneDelete.jsp?vodfoneId=${vodafoneUser.getVodafoneId()}&planName=${vodafoneUser.getPlanName()}&price=${vodafoneUser.getPrice()}&validity=${vodafoneUser.getValidity()}&benefits=${vodafoneUser.getBenfits()}&operator=${vodafoneUser.getOperator().getOperatorname()}">Edit</a></td>
