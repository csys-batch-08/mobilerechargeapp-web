...
<body style="text-align: center;">
	...
	<table aria-describedby="AdminPlanAirtel" style="width: 100%;">
		<tr>
		...
		<c:forEach items="${requestScope.airtellist}" var="airtelUser">
			<tr>
				...
				<td><a
					href="airtelDelete.jsp?airtelId=${airtelUser.getAirtelId()}&planName=${airtelUser.getPlanName()}&price=${airtelUser.getPrice()}&validity=${airtelUser.getValidity()}&benefits=${airtelUser.getBenfits()}&operator=${airtelUser.getOperator().getOperatorname()}">Delete</a></td>
