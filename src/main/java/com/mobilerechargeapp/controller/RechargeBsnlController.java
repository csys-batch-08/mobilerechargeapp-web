...
@WebServlet("/RechargeBsnlController")
public class RechargeBsnlController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			session.setAttribute("balanceBsnl", e.getMessage1());
			response.sendRedirect("planBsnlUser");
		}
	}
}
