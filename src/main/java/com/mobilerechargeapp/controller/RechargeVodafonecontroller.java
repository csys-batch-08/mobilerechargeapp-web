...
@WebServlet("/RechargeVodafonecontroller")
public class RechargeVodafonecontroller extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			session.setAttribute("balanceVodafone", e.getMessage1());
			response.sendRedirect("planVodafoneUser");
		}
	}
